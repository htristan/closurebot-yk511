...
# In the Yukon version of this bot, we don't have polygons, as we are just mapping everything into one channel
# So, you may notice that is missing here compared to the other versions - that is intentional
